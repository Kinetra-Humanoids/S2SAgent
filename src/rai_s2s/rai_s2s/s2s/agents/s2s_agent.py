...
from rai_s2s._s2s_types import PlayData, ThreadData
...
class SpeechToSpeechAgent(BaseAgent):
    def __init__(
        ...
        *,
        ...
        speaker_config: Optional[SoundDeviceConfig],
        ...
        **kwargs,
        ...
        if logger is not None:
            self.logger = logger
        targets = [] if speaker_config is None else [("speaker", speaker_config)]
        ...
        if speaker_config is None:
            sample_rate, out_channels = 16000, 1
        else:
