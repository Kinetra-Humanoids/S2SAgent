...
Usage (on robot)::
    ...
    python -m rai.tools.python.camera.composed_camera \\
        --ego-view-camera oak \\
...
Run ``python -m rai.tools.python.camera.composed_camera --help`` for all options.
"""
...
from rai.tools.python.camera.sensor import Sensor
from rai.tools.python.camera.sensor_server import (
    CameraMountPosition,
    ImageMessageSchema,
    SensorClient,
    SensorServer,
...
class ComposedCameraSensor(Sensor, SensorServer):
    ...
    def _instantiate_camera(
        ...
        if camera_type in ("oak", "oak_mono"):
            from rai.tools.python.camera.drivers.oak import OAKConfig, OAKSensor
            ...
            from rai.tools.python.camera.drivers.realsense import RealSenseSensor
            ...
            from rai.tools.python.camera.drivers.dummy import ReplayDummySensor

            print(f"Initializing Replay Dummy Sensor for camera type: {camera_type}")
            return ReplayDummySensor(video_path=camera_type)

        elif camera_type == "usb":
            from rai.tools.python.camera.drivers.usb_camera import USBCameraConfig, USBCameraSensor
